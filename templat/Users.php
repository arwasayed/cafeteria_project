...
<div class="addProduct" ><a  style="float:right;margin-right:30px;font-size:20px" href="AddUser.php">Add User</a></div>
<div class="containerr">
	
	<div class="table">
		<div class="table-header">
			<div class="header__item"><a id="Product" class="filter__link" href="#">Name</a></div>
            ...
            <div class="header__item"><a id="Active" class="filter__link filter__link--number" href="#">Action</a></div>
